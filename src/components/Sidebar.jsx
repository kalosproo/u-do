...
import { FiGrid, FiDollarSign, FiCalendar, FiCheckSquare, FiActivity, FiUser, FiLogOut } from "react-icons/fi";
    ...
    <aside className="sidebar">
      <div className="sidebar-top">
        ...
        <div className="sidebar-profile" aria-label="Current user profile">
          {user?.photoURL ? (
            <img src={user.photoURL} alt={userName} className="profile-avatar-image" />
          ) : (
